          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-12 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Universidades</strong><span>hace 7 min</span>
                  <div class="count-number">25</div>
                </div>
              </div>
            </div>
          ...
          <div class="row d-flex">
            <div class="col-lg-4">
              ...
              <div class="card income text-center">
                ...
                <div class="number">126,418</div><strong class="text-primary">Usuarios</strong>
            ...
            <div class="col-lg-4">
              ...
              <div class="card user-activity">
                ...
                <div class="page-statistics d-flex justify-content-between">
                  <div class="page-statistics-left"><span>Pag Visitadas</span><strong>230</strong></div>
                  ...
                  <ul class="news list-unstyled">
                    ...
                    <li class="d-flex justify-content-between"> 
                      <div class="left-col d-flex">
                        ...
                        <div class="title"><strong>Bienvenidos a la comunidad de OrientaU</strong>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div id="daily-feeds" class="card updates daily-feeds">
                <div id="feeds-header" class="card-header d-flex justify-content-between align-items-center">
                  <h2 class="h5 display"><a data-toggle="collapse" data-parent="#daily-feeds" href="#feeds-box" aria-expanded="true" aria-controls="feeds-box">Mensajes </a></h2>
                  <div class="right-column">
                    <div class="badge badge-primary">3 messages</div><a data-toggle="collapse" data-parent="#daily-feeds" href="#feeds-box" aria-expanded="true" aria-controls="feeds-box"><i class="fa fa-angle-down"></i></a>
                  </div>
                </div>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../../img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                            <div class="content"><strong>Jason Doe</strong><small>Problema de sesion </small>
