<?php
    ...
    if(isset($_SESSION['usuario'])){
        ...
        }else if($_SESSION['usuario']['UsuarioTipo'] == 4 ){
            header('Location: ../tutorado/');
        }*/
    }else{
           // header('location: ../');
        }
    ...
    try{
        ...
        $consultaCoordinador = mysqli_query($mysqli,"SELECT * FROM usuarios INNER JOIN coordinador ON usuarios.IDUsuario = coordinador.IDUsuario WHERE UsuarioTipo = 2 ");
    }catch(Exception $e){
        ...
        <nav class="navbar">
          ...
          <div class="row justify-content-center mt-5 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              ...
              <h4 class="">Registrar IT</h4>
                    </div>
                <div class="card-body">
        <div class="container">

<form role="form" id="form" action="consultas/insertar-it.php" method="post">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
			    ...
			    <div class="form-controlGroup">
					<input class="form-input" name="ClaveIT" type="text" id="ClaveIT" required/>
					<label class="form-label" for="ClaveIT">Clave IT:</label>
					<i class="form-inputBar"></i>
				</div>
                <div class="form-controlGroup">
					<label class="form-label" for="lista_estado">Estado:</label>  
                    <select id="lista_estado" name="lista_estado" class="form-control"></select>
					<i class="form-inputBar"></i>
				</div>
                <div class="form-controlGroup">
                ...
                <div class="form-controlGroup">
                    <label class="form-label" for="it">Instituto Tecnológico:</label>
                    <select id="it" name="Nombre" class="form-control"></select>
					<i class="form-inputBar"></i>
				</div>
                <div class="form-controlGroup">
					<input class="form-input" name="Direccion" type="text" id="Direccion" required/>
					<label class="form-label" for="Direccion">Dirección:</label>
					<i class="form-inputBar"></i>
				</div>
                <div class="form-controlGroup">
					<input class="form-input" name="LogoRuta" type="text" id="LogoRuta" required/>
					<label class="form-label" for="LogoRuta">Logo Ruta:</label>
					<i class="form-inputBar"></i>
				</div>
                <div class="form-controlGroup">
					<input class="form-input" name="SubtituloFormatos" type="text" id="SubtitulosFormatos" required/>
					<label class="form-label" for="SubtitulosFormatos">Subtitulo Formatos:</label>
					<i class="form-inputBar"></i>
				</div>    
                <div class="form-controlGroup">
                    <label for="IDCoordinador" class="form-label">Coordinador:</label>
                    <select id="IDCoordinador" name="IDCoordinador" class="form-control">                    
                        <?php while($datoCoordinador = mysqli_fetch_array($consultaCoordinador)) { ?>
                            <option value="<?php echo $datoCoordinador['IDCoordinador']; ?>"> <?php echo $datoCoordinador['Nombres']; ?> <?php echo $datoCoordinador['ApellidoP']; ?> <?php echo $datoCoordinador['ApellidoM']; ?></option>
                        <?php } ?>
                    </select>
                    <i class="form-inputBar"></i>
