					...
					<table class="table ">
					  <thead>
						<tr class="table-primary titulo-tabla">
						  ...
						  <th scope="col">Instituto Tecnológico</th>
					  ...
					  <tbody>
                        <?php while($datosit = mysqli_fetch_array($consultas)) { ?>
                        <tr>
                            <th scope="row"><?php echo $datosit['ClaveIT']; ?></th>
                            <td><?php echo $datosit['Nombre']; ?></td>
                            <td><?php echo $datosit['Direccion']; ?></td>
