  ...
  session_start();
    ...
    if(isset($_SESSION['usuario'])){
       /*if($_SESSION['usuario']['UsuarioTipo'] == 2 ){
        ...
        }else if($_SESSION['usuario']['UsuarioTipo'] == 3 ){juancach
    ...
    try{
        ...
        $coordinador = mysqli_query($mysqli,"SELECT * FROM usuarios WHERE UsuarioTipo = 2;  ");
        }catch(Exception $e){
        ...
        <div class="container-fluid ">
          <div class="row d-flex ">
            ...
            <div class="card-header d-flex justify-content-center ">
            	<h4 class="">Administrar Coordinador</h4>
            </div>
			  <div class="table-responsive tabla-tutorados">
					...
					<table class="table ">
					  ...
					  <tbody>
					<?php while($datoscoordinador = mysqli_fetch_array($coordinador)) { ?>
                        <tr>
                            <th scope="row"><?php echo $datoscoordinador['Nombres']; ?></th>
                            <td><?php echo $datoscoordinador['ApellidoP']; ?></td>
                            <td><?php echo $datoscoordinador['ApellidoM']; ?></td>
                            <td><?php  $sexo = $datoscoordinador['Sexo'];
                                if($sexo == 0 ){
                                    $imp = "    Hombre";
                                }elseif($sexo == 1){
                                    $imp = "Mujer";
                                ...
                                echo $imp;                                                        
                                ?></td>
                            <td><?php echo $datoscoordinador['FechaNacimiento']; ?></td>
                            <td><?php echo $datoscoordinador['FechaAlta']; ?></td>
                            <td><?php echo $datoscoordinador['Correo']; ?></td>
                            <td><?php echo $datoscoordinador['Password']; ?></td>
                            <td><?php echo $datoscoordinador['LinnkFoto']; ?></td>
                            <td><a href=""><i class="fas fa-user-cog fa-3x"></i></a></td>
						      <td><a href=""><i class="fas fa-user-minus fa-3x"></i></a></td>
                        </tr>
                    <?php } ?>
					  </tbody>
					</table>
