<?php
  session_start();
    ...
    try{
        ...
        $consultasTutorado = mysqli_query($mysqli,"SELECT * FROM usuarios WHERE UsuarioTipo = 4");
        }catch(Exception $e){
            ...
            <div class="card-header d-flex justify-content-center ">
			  ...
			  <div class="table-responsive tabla-tutorados">
					...
					<table class="table ">
					  ...
					  <tbody>
                        <?php while($datostutorado = mysqli_fetch_array($consultasTutorado)) { ?>
                        <tr>
                            <th scope="row"><?php echo $datostutorado['Nombres']; ?> <?php echo $datostutorado['ApellidoP']; ?> <?php echo $datostutorado['ApellidoM']; ?></th>
                            <td><?php echo $datostutorado['Correo']; ?></td>
                            <td><?php  $sexo = $datostutorado['Sexo'];
                                if($sexo == 0 ){
                                    $imp = "    Hombre";
                                }elseif($sexo == 1){
                                    $imp = "Mujer";
                                ...
                                echo $imp;                                                        
                                ?></td>
                            <td><?php echo $datostutorado['FechaNacimiento']; ?></td>
                            <td><?php echo $datostutorado['FechaAlta']; ?></td>
