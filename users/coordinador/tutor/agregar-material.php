    ...
    <div class="page">
      ...
      <header class="header">
        <nav class="navbar">
          ...
          <div class="row justify-content-center mt-5 mb-3 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              <div class="card">
              <div class="card-header d-flex justify-content-center ">
                 
              <h4 class="">Agregar Materiales</h4>
                    </div>
                <div class="card-body">
        <div class="container">
...
<form role="form" id="form" >
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
				...
				<label class="form-label mt-3 ml-3" for="correo">Subir Archivo</label>
  ...
  <label class="custom-file-label" for="customFileLang">Seleccionar Archivo</label>
                   ...
                   <div class="form-controlGroup">
					<input class="form-input" name="" type="email" name="" id="correo" required/>
					<label class="form-label" for="correo">Proporcione el link del material</label>
					<i class="form-inputBar"></i>
				</div>
                
                  <div class="form-controlGroup">
					<input class="form-input" name="" type="email" name="" id="academia" required/>
					<label class="form-label" for="academia">Descripción del material</label>
					<i class="form-inputBar"></i>
				</div>
      ...
      <footer class="main-footer  mt-5 col-md-12">
        <div class="container-fluid">
          <div class="row">
