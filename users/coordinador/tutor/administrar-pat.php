        ...
        <div class="container-fluid ">
          <div class="row d-flex ">
            ...
            <div class="card-header d-flex justify-content-center ">
            	<h4 class="">Plan de Acción Tutorial</h4>
            </div>
			  <div class="table-responsive tabla-tutorados">
					...
					<table class="table ">
					  ...
					  <tbody>
						<tr>
						  <th scope="row">Actividades de Introducción</th>
						  <td>Roger Alejandro Uitzil Cach</td>
						  <td>05/09/2018</td>
						...
						<tr>
						  <th scope="row">Actividades de Integración</th>
						   <td>Jose Ramiro May Yam</td>
						 <td>01/09/2018</td>
