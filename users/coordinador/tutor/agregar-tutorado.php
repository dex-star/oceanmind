<?php
  session_start();
    ...
    try{
        ...
        $consultas = mysqli_query($mysqli,"SELECT * FROM grupo");
        }catch(Exception $e){
        ...
        <nav class="navbar">
          ...
          <div class="row justify-content-center mt-5 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              ...
              <h4 class="">Agregar Tutorado</h4>
                    </div>
                <div class="card-body">
        <div class="container">

<form role="form" id="form" action="consultas/insertar-tutorado.php" method="post">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
                ...
                <div class="form-controlGroup">
					<input class="form-input" name="Password" type="text" name="" id="Pass" value="12345" readonly required/>
					<label class="form-label" for="Pass">Contraseña:</label>
					<i class="form-inputBar"></i>
                </div>        
				
				<div class="form-controlGroup" hidden>
					<select id="user" readonly="" name="UsuarioTipo" class="form-input form-input--select" required >
						 <option value="4">Tutorado</option>
                    </select>
                ...
                <div class="form-controlGroup">
					<select id="Estatus" name="Estatus" class="form-input form-input--select" required>
                         <option value="1">Activo</option>
						 <option value="0">Inactivo</option>                         
                    </select>
					<label class="form-label" for="user">Estatus:</label>
					<i class="form-inputBar"></i>
				</div>
                ...
                <div class="form-controlGroup">
                    ...
                    <select id="IDGrupo" name="IDGrupo" class="form-control">                    
                        <?php while($datoGrupo = mysqli_fetch_array($consultas)) { ?>
                            <option value="<?php echo $datoGrupo['IDGrupo']; ?>"><?php echo $datoGrupo['Aula']; ?></option>
                        <?php } ?>
                    </select>
                    <i class="form-inputBar"></i>                    
                </div>    
                ...
                <div class="form-controlGroup">
					<input class="form-control" readonly hidden name="IDAvatar" type="text" id="IDAvatar" value="1">
                </div>    
