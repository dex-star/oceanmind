<?php
  session_start();
    ...
    try{
        ...
        $usuariocoordinador = mysqli_query($mysqli,"SELECT * FROM usuarios WHERE IDUsuario = '$sesionActual' ");
        $data2=mysqli_fetch_assoc($usuariocoordinador);
        $nombrecoordinador = $data2['Nombres'];
        $apellidopcoordinador = $data2['ApellidoP'];
        $apellidomcoordinador = $data2['ApellidoM'];
        
        $idcoordinador = mysqli_query($mysqli,"SELECT * FROM coordinador WHERE IDUsuario = '$sesionActual' ");
        $data3=mysqli_fetch_assoc($idcoordinador);
        $coordinador = $data3['IDCoordinador'];    
...
<form role="form" id="form" action="consultas/insertar-tutor.php" method="post">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
                ...
                <div class="form-controlGroup">
                        ...
                        <textarea class="form-control" readonly name="IDCoordinador" type="text" value="<?php echo $coordinador ?>" id="IDCoordinador"><?php echo $coordinador ?> <?php echo $nombrecoordinador ?> <?php echo $apellidopcoordinador ?> <?php echo $apellidomcoordinador ?></textarea>
                        <label class="form-label" for="IDCoordinador">Coordinador:</label>
					    <i class="form-inputBar"></i>                   
                </div>    
