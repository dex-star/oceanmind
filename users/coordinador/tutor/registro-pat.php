        ...
        <div class="col-md-12">
            <div class="col-xs-12">
			    ...
			    <div class="form-controlGroup">
					<input class="form-input" name="" type="text" id="Nombre" required/>
					<label class="form-label" for="lugar">Actividad:</label>
                   ...
                   <div class="form-controlGroup">
					...
					<label class="form-label" for="correo">Responsable:</label>
					<i class="form-inputBar"></i>
				</div>
...
<input name="" type="date" class="form-input" id="fecha" value="">
