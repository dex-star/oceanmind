<?php
  session_start();
    ...
    try{
        ...
        $ConsultaCoordinador = mysqli_query($mysqli,"SELECT * FROM coordinador WHERE IDUsuario = '$sesionActual' ");
        $data3=mysqli_fetch_assoc($ConsultaCoordinador);
        $coordinadores = $data3['IDCoordinador'];

        $consultaTutor = mysqli_query($mysqli,"SELECT * FROM usuarios INNER JOIN tutor ON usuarios.IDUsuario = tutor.IDUsuario WHERE IDCoordinador = $coordinadores");
        
        $consultaCarrera = mysqli_query($mysqli,"SELECT * FROM carrera");
        ...
        <nav class="navbar">
          ...
          <div class="row justify-content-center mt-5 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              ...
              <h4 class="">Agregar Grupo</h4>
                    </div>
                <div class="card-body">
        <div class="container">

<form role="form" id="form" action="consultas/insertar-grupo.php" method="post">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
				...
				<div class="form-controlGroup">
					<select id="Periodo" name="Periodo" class="form-input form-input--select justify-content-center" required>
					...
					<label class="form-label" for="Periodo">Semestre:</label>
					
					<i class="form-inputBar"></i>
				</div>
                 
                <div class="form-controlGroup">
					<select id="IDCarera" name="IDCarrera" class="form-input form-input--select" required>
						  <?php while($datoCarrera = mysqli_fetch_array($consultaCarrera)) { ?>
                            <option value="<?php echo $datoCarrera['IDCarrera']; ?>"> <?php echo $datoCarrera['Nombre']; ?> </option>
                            <?php } ?>
					</select>
					<label class="form-label" for="IDCarrera">Carrera:</label>
			    ...
			    <div class="form-controlGroup">
					<input class="form-input" name="Aula" type="text" id="Aula" required/>
                ...
                <div class="form-controlGroup">
					<select id="Turno" name="Turno" class="form-input form-input--select" required>
						<option value="0">Matutino</option>
                        <option value="1">Vespertino</option>               
					</select>
					<label class="form-label" for="sexo">Turno:</label>
                ...
                <div class="form-controlGroup">
                    ...
                    <select id="IDTutor" name="IDTutor" class="form-control">                    
                        <?php while($datoTutor = mysqli_fetch_array($consultaTutor)) { ?>
                            <option value="<?php echo $datoTutor['IDTutor']; ?>"> <?php echo $datoTutor['Nombres']; ?> <?php echo $datoTutor['ApellidoP']; ?> <?php echo $datoTutor['ApellidoM']; ?></option>
                        <?php } ?>
                    </select>
                    <i class="form-inputBar"></i>
