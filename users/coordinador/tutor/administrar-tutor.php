<?php
  session_start();
    ...
    try{
        ...
        $consultasTutor = mysqli_query($mysqli,"SELECT * FROM usuarios WHERE UsuarioTipo = 3");
        }catch(Exception $e){
            ...
            <div class="card-header d-flex justify-content-center ">
			  ...
			  <div class="table-responsive tabla-tutorados">
					...
					<table class="table ">
					  ...
					  <tbody>
                        <?php while($datostutor = mysqli_fetch_array($consultasTutor)) { ?>
                        <tr>
                            <th scope="row"><?php echo $datostutor['Nombres']; ?> <?php echo $datostutor['ApellidoP']; ?> <?php echo $datostutor['ApellidoM']; ?></th>
                            <td><?php echo $datostutor['Correo']; ?></td>
                            <td><?php  $sexo = $datostutor['Sexo'];
                                if($sexo == 0 ){
                                    $imp = "    Hombre";
                                }elseif($sexo == 1){
                                    $imp = "Mujer";
                                ...
                                echo $imp;                                                        
                                ?></td>
                            <td><?php echo $datostutor['FechaNacimiento']; ?></td>
                            <td><?php echo $datostutor['FechaAlta']; ?></td>
