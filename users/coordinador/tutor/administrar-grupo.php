<?php
  session_start();
    ...
    try{
        ...
        $consultas = mysqli_query($mysqli,"SELECT * FROM usuarios INNER JOIN tutor ON usuarios.IDUsuario = tutor.IDUsuario WHERE IDUsuario = '$sesionActual' ");
        $grupo = mysqli_query($mysqli,"SELECT * FROM grupo");
        }catch(Exception $e){
            ...
            <div class="card-header d-flex justify-content-center ">
			  ...
			  <div class="table-responsive tabla-tutorados">
					...
					<table class="table ">
					  ...
					  <tbody>
                        <?php while($datosgrupo = mysqli_fetch_array($grupo)) { ?>
                        <tr>
                            <th scope="row"><?php echo $datosgrupo['Aula']; ?></th>
