  ...
  <body>
    ...
    <div class=" setup-panel">
        ...
        <div class="container-fluid">
			<section class="fd">
      <div class="container ">
        <div class=" setup-content  animated slideInRight " id="step-1">
        <div class="">
       <div class="col-md-12">
       ...
       $consultas5 = mysqli_query($mysqli,"SELECT * FROM tutorado WHERE IDUsuario = '$sesionActual' ");
        ...
        if(!empty($fortaleza1 == "" && $oportunidades1 == "" && $debilidades1 == "" && $amenaza1 == "")){
	...
	<div class="col-lg-4">
      ...
      ?> 
                    ...
                    <div role="document" class="modal-dialog">
                      <div class="modal-content modal1">
                        ...
                        <div class="modal-body">
                          ...
                          <form method="post" action="consultas/insertar-fortaleza.php" target="blank">
        ...
        <?php } ?>
          ...
          <textarea name="IDTutorado" hidden=""><?php echo $datosconsultas4['IDTutorado']; ?></textarea>
        <?php } ?>
				<div class="form-group">
                        <div class="controls">
