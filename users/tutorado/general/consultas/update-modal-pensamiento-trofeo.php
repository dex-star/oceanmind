...
$mysql="UPDATE `Notificaciones` SET `edo_notificacion` = '1' WHERE IDTutorado = '$TutoradoN' AND Descripcion = 'Trofeo-HabilidadDelPensamiento desbloqueado' ";
mysqli_query($mysqli,$mysql) or die (mysqli_error($mysqli));

echo'<script type="text/javascript">
        window.location.href="../Logica-avatar.php";
        </script>';
mysqli_close($mysqli)
