...
$mysql="UPDATE `Notificaciones` SET `edo_notificacion` = '1' WHERE IDTutorado = '$TutoradoN' AND Descripcion = 'Avatar-1 desbloqueado' ";
mysqli_query($mysqli,$mysql) or die (mysqli_error($mysqli));

echo'<script type="text/javascript">
        window.location.href="../Estilo-aprendizaje.php";
        </script>';
mysqli_close($mysqli)
