              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item dropdown"> <a id="notifications" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-bell fa-2x"></i><span class="badge contadornoti"><?php echo $resultado_contar->num_rows; ?></span></a>
                  <ul aria-labelledby="notifications" class="dropdown-menu shadow p-3 mb-5 bg-white rounded dropdown-menu-right navbar-dropdown animated bounceInDown">
                    ...
                    <li><a rel="nofollow" href="#" class="dropdown-item all-notifications text-center"> <strong> <i class="fa fa-bell"></i>Ver noticaciones</strong></a></li>
                  </ul>
                </li>
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item btn-normateca">
        <a class="nav-link btn-normateca-letra" href="normateca-info.php#carouselExample" >Orienta·Info</a>
      </li>
      <li class="nav-item btn-normateca"  style=" color: #fff;
    background-color: #308ee0; border-radius: 10px;">
        <a class="nav-link btn-normateca-letra" href="normateca-docs.php#carouselExample" style="color: #fff;">Orienta·Docs</a>
      </li>
      <li class="nav-item btn-normateca">
