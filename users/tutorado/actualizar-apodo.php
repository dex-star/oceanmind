    ...
    <div class="page">
      ...
      <header class="header">
       ...
       <div>
          ...
          <form method="POST" action="consultas/update-apodo.php" id="changepass" name="changepass">
            ...
            <div class="col-xs-12">
             ...
             <div class="fondo-card container">
                ...
                <h1 class="titulo-cambio">Por favor, Actualiza tu usuario</h1>
          ...
          <div class="form-group d-flex justify-content-center ">
            ...
            <input type="submit" id="Cambiar" class="btn-cambiar" value="Actualizar">
            </div>
