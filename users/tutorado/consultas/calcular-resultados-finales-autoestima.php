...
//CONSULTA PARA OBTENER IDTUTORADO
        ...
        $Tecnicas2="UPDATE `resultados-generales` SET Identificacion='$resultadoIdentificacion', DesarrolloHumano = '$resultadoDesarrolloHumano', HabilidadesPensamiento = '$resultadoHabilidadPensamiento', Fortalecimiento = '$resultadoFortalecimiento', AvanceGeneral = '$resultado' WHERE IDTutorado = '$tutorado2'";
            mysqli_query($mysqli,$Tecnicas2) or die (mysqli_error($mysqli));
            mysqli_close($mysqli);
        header("location: ../desarrollo-humano/index-trofeo-autoestima.php")
