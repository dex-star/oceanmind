<?php
  session_start();
    ...
    try{
        ...
        $ConsultaNotificacion = mysqli_query($mysqli,"SELECT * FROM `Notificaciones` WHERE IDTutorado = '$tutorado' AND Descripcion = 'Trofeo-HabilidadesDeEstudio desbloqueado' ");
...
echo'</div>';
    ...
    <!-- modal trofeo habilidades estudio -->
    <center>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="fb-share-button" data-href="http://oceanmind.com.mx/compartir/trofeo-habilidades-estudio.php" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Compartir</a>
            </div>
            
          </div>
          
          <form action="consultas/update-modal-trofeo-he.php" method="POST">
