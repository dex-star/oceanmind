        ...
        <div class="container d-flex justify-content-center ">
         <?php 
                  ...
                  <div class="step active">
                        <a href="autoestima.php"><div class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-smile-beam"></i><p class="titulo-point">Autoestima</p></div>                        
                      </a></div>';
                      }else{
                           echo '<div class="step-progress">
                        <br>
                        <div class="step">
                        <a href="autoestima.php"><div style="color: #31C6C7;" class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-smile-beam"></i><p class="titulo-point">Autoestima</p></div>                        
                      </a></div>';
                      }
                        ...
                        <br>
                        <div class="step">
                        <a href="avisoDesarrollo.php"><div style="color: #FFFFF;" class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-smile-beam"></i><p class="titulo-point">Autoestima</p></div>                        
                      </a></div>';
                      }
                //Asertividad        
                  if ($tutorado = $tutoradoAutoestima) {
                      if($tutorado = $tutoradoAsertividad){echo '<div class="step active">
                          ...
                          <a href="asertividad.php"><div class="point" ><i class="fas fa-comments"></i><p class="titulo-point">Asertividad</p></div>
                          </a></div>
                      ';}
                      else{echo '<div class="step ">
                            <div class="progress"></div>
                          <a href="asertividad.php"><div style="color: #31C6C7;" class="point" ><i class="fas fa-comments"></i><p class="titulo-point">Asertividad</p></div>
                          </a></div>
                      ';}
                  }
                  else{
                      echo '<div class="step">
                            <div class="progress"></div>
                          <a href="avisoDesarrollo.php"><div style="color: #FFFFF;" class="point" ><i class="fas fa-comments"></i><p class="titulo-point">Asertividad</p></div>
                          </a></div>
                      ';
                  }
                ...
                if ($tutorado = $tutoradoAsertividad) {
                      if($tutorado = $tutoradoHabilidades){
                          ...
                          echo '
                            <div class="step active">
                              <div class="progress"></div>
                              <a href="habilidades-estudio.php"><div class="point" ><i class="fas fa-award"></i><p class="titulo-point">Habilidades</p><p class="titulo-point2">de Estudio</p></div>
                            </a></div>
                          ';
                      }
                      else{
                           ...
                           echo '
                            <div class="step">
                              <div class="progress"></div>
                              <a href="habilidades-estudio.php"><div style="color: #31C6C7;" class="point" ><i class="fas fa-award"></i><p class="titulo-point">Habilidades</p><p class="titulo-point2">de Estudio</p></div>
                            </a></div>';
                      ...
                      echo '
                        <div class="step">
                              <div class="progress"></div>
                              <a href="avisoDesarrollo.php"><div style="color: #FFFFF;" class="point" ><i class="fas fa-award"></i><p class="titulo-point">Habilidades</p><p class="titulo-point2">de Estudio</p></div>
                            </a></div>';  
                  }
