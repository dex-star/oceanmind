         ...
         <?php 
                ...
                //FODA                
                  if ($tutorado = $tutoradoID) {
                      ...
                      echo '<div class="step">
                            <div class="progress"></div>
                          <a href="avisoIdentificacion.php"><div style="color: #FFFFF;" class="point" ><i class="fas fa-puzzle-piece"></i><p class="titulo-point">FODA</p></div>
                          </a></div>
                      ';
                  }
                ...
                if (!empty($fortaleza1 != "" && $oportunidad1 != "" && $debilidad1 != "" && $amenaza1 != "")) {
                      ...
                      echo '
                        <div class="step">
                              <div class="progress"></div>
                              <a href="avisoIdentificacion.php"><div style="color: #FFFFF;" class="point" ><i class="fas fa-heartbeat "></i><p class="titulo-point">Linea de Vida</p></div>
                            </a></div>';  
                  }
                ...
                if ($tutorado = $tutoradoLV) {
                     ...
                     echo '
                                <div class="step">
                                      <div class="progress"></div>
                                      <a href="avisoIdentificacion.php"><div style="color: #FFFFF;" class="point" ><i class="fas fa-book-open"></i><p class="titulo-point">Estilos Aprendizaje </p></div>
                                    </a></div>
                              '; 
                  }
