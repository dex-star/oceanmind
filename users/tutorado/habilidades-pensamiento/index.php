  ...
  <body>
    ...
    <div class="page">
     ...
     <!--Inicio de Preguntas-->
      ...
      <h2 class="animated bounce titulo-dash">¡Ponte a prueba!</h2>
                </div>
        ...
        <div class="container d-flex justify-content-center ">
         <?php 
                  ...
                  $ConsultaLogica = mysqli_query($mysqli,"SELECT * FROM `test-logica` WHERE IDTutorado = '$tutorado' ");
                  $data2=mysqli_fetch_assoc($ConsultaLogica);
                  $tutoradoLogica = $data2['IDTutorado'];
                  
                  //VERIFICAR HABILIDADES ESTUDIO
                  
                  $ConsultaHabilidades = mysqli_query($mysqli,"SELECT * FROM `habilidades-estudio` WHERE IDTutorado = '$tutorado' ");
                  $data4=mysqli_fetch_assoc($ConsultaHabilidades);
                  $tutoradoHabilidades = $data4['IDTutorado'];

                  //Logica
                  if ($tutorado = $tutoradoHabilidades) {
                      if($tutorado = $tutoradoLogica){
                          echo '<div class="step-progress">
                          <br>
                          <div class="step active">
                                <a href="logica.php"><div class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-user-astronaut"></i><p class="titulo-point">Lógica</p></div>                        
                              </a></div>';
                      }else{
                          echo '<div class="step-progress">
                            <br>
                            <div class="step">
                            <a href="logica.php"><div style="color: #31C6C7;" class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-user-astronaut"></i><p class="titulo-point">Lógica</p></div>                        
                          </a></div>';
                      }
                        ...
                        <br>
                        <div class="step">
                        <a href="avisoHabilidades.php"><div style="color: #FFFFF;" class="point" onclick="toggle(this)" id="myButton"><i class="fas fa-user-astronaut"></i><p class="titulo-point">Lógica</p></div>                        
                      </a></div>';
                      }
