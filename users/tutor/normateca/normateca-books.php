...
<html>
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      ...
      <li class="nav-item btn-normateca">
        <a class="nav-link btn-normateca-letra" href="normateca-docs.html#carouselExample">Orienta·Docs</a>
      </li>
      <li class="nav-item btn-normateca"  style=" color: #fff;
    background-color: #308ee0;
    border-radius: 10px;">
        <a class="nav-link btn-normateca-letra" href="normateca-books.html#carouselExample" style="color: #fff;">Orienta·Books</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
