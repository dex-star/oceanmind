      ...
      <header class="header">
       ...
       <div class="row justify-content-center mt-5 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              ...
              <h4 class="">Agregar Reporte Mensual</h4>
                    </div>
                <div class="card-body">
        <div class="container">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
                <div class="form-group">
					...
					<input class="form-input" type="text" name="" id="fechas" required/>
					<label class="form-label" for="fechas">Fecha:</label>
					<i class="form-inputBar"></i>
				</div>
               
			    <div class="form-controlGroup">
					<input class="form-input" name="" type="number" id="sesion" required/>
					<label class="form-label" for="sesion">Número sesiones:</label>
					<i class="form-inputBar"></i>
				</div>
                 
                 	<div class="form-controlGroup">
					<select id="mes" name="" class="form-input form-input--select" required>
						<option value=""></option>
                   ...
                   <div class="form-controlGroup">
					<input class="form-input"  type="number" name="" id="alumnos" required/>
					<label class="form-label" for="alumnos">Número alumnos:</label>
					<i class="form-inputBar"></i>
				</div>
                   <div class="form-controlGroup">
					<input class="form-input"  type="number" name="" id="alumnosdeu" required/>
					<label class="form-label" for="alumnosdeu">Alumnos deudores:</label>
					<i class="form-inputBar"></i>
				</div>
                   <div class="form-controlGroup">
					<input class="form-input"  type="number" name="" id="alumnosbaja" required/>
					<label class="form-label" for="alumnosbaja">Bajas Alumno:</label>
					<i class="form-inputBar"></i>
				</div>   
				<div class="form-controlGroup">
					<input class="form-input"  type="number" name="" id="cumpli" required/>
					<label class="form-label" for="cumpli">Porcentaje Cumplimiento:</label>
					<i class="form-inputBar"></i>
				</div>
				<div class="form-controlGroup">
					<input class="form-input"  type="text" name="" id="problemas" required/>
					<label class="form-label" for="problemas">Problemas detectados:</label>
					<i class="form-inputBar"></i>
				</div>
				<div class="form-controlGroup">
					<input class="form-input"  type="text" name="" id="areas" required/>
					<label class="form-label" for="areas">Áreas canalizadas:</label>
					<i class="form-inputBar"></i>
				</div>
				 <div class="form-controlGroup">
						<input class="form-input"  type="text" name="" id="activi" required/>
						<label class="form-label" for="activi">Actividades programadas:</label>
						<i class="form-inputBar"></i>
					</div>
					 <div class="form-controlGroup">
						<input class="form-input"  type="number" name="" id="tempo" required/>
						<label class="form-label" for="tempo">Bajas temporales:</label>
						<i class="form-inputBar"></i>
					</div>
                 	 <div class="form-controlGroup">
						<input class="form-input"  type="text" name="" id="accion" required/>
						<label class="form-label" for="accion">Acciones problema:</label>
						<i class="form-inputBar"></i>
					</div>
                      <div class="form-controlGroup">
						<input class="form-input"  type="number" name="" id="inasistencia" required/>
						<label class="form-label" for="inasistencia">Inasistencia Alumnos:</label>
						<i class="form-inputBar"></i>
					</div>
					   <div class="form-controlGroup">
						<input class="form-input"  type="text" name="" id="observar" required/>
						<label class="form-label" for="observar">Observaciones:</label>
						<i class="form-inputBar"></i>
					</div>
