      ...
      <header class="header">
       ...
       <div class="row justify-content-center mt-5 col-sm-12 ml-1 mr-1 container">
           <div class="col-md-10 col-sm-12">
              ...
              <h4 class="">Agregar Plan de Acción Tutorial</h4>
                    </div>
                <div class="card-body">
        <div class="container">
        ...
        <div class="col-md-12">
            <div class="col-xs-12">
			    ...
			    <div class="form-controlGroup">
					<input class="form-input" name="" type="text" id="actividad" required/>
					<label class="form-label" for="actividad">Actividad:</label>
					<i class="form-inputBar"></i>
				</div>
                  
                   <div class="form-controlGroup">
					<input class="form-input"  type="text" name="" id="respo" required/>
					<label class="form-label" for="respo">Responsable</label>
					<i class="form-inputBar"></i>
				</div>
                
                  <div class="form-controlGroup">
					<input class="form-input" type="text" name="" id="fechas" required/>
					<label class="form-label" for="fechas">Fechas</label>
					<i class="form-inputBar"></i>
				</div>
